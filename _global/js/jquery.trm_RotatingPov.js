    ...
    $.fn.trm_RotatingPov = function (options) {
        ...
        function doTrack(type, curr, next, opts){
			...
			switch(type.toUpperCase()){
				case 'CLICK':
					trackConverge(converges[index], 'Interaction');
				break;
...
/*        function trackConverge(cid){
        ...
        function trackConverge(cid, ctype){
        	l(cid + ', ' + ctype);
        	if(typeof DynamicOmnitureTracking != 'undefined'){
        		DynamicOmnitureTracking(cid, ctype);
        	}
        }
        ...
        function onPauseButtonClick(){
        	if(manualPause == false){
        		...
        		manualPause = true;
        		trackConverge(converges[currentPov]+' Pause', 'Interaction');
        	}
        	else{
            	...
            	$(options.pager).mouseover(pauseTimer).mouseout(startTimer);
            	manualPause = false;
            	trackConverge(converges[currentPov]+' Play', 'Interaction');
        	}
        }
        ...
        function povType(d){
        	...
        	$(d.links).find('link').each(function(){
        		...
        		///////////////////////////
        		if ($(this).attr('class')) {
        			if ($(this).attr('class').match('iframe')!==null) {
        				clickAction = '$(this).colorbox({iframe:true, scrolling:false, innerWidth:'+iframeWidth+', innerHeight:'+iframeHeight+'});'
        			}
        		}
        		///////////////////////////
        		...
        		var pos  = 'position:absolute;';
        			pos  += 'top:'+$(this).attr('y')
        			pos  += ';left:'+$(this).attr('x')
        			pos  += ';width:'+$(this).attr('w')
        			pos  += ';height:'+$(this).attr('h')
        			pos  += ';'+debug+'";'
        		...
        		// hotSpots += '<a onclick="'+clickAction+'" itrack="'+itrack+'" itype="'+$(this).attr('itype')+'" href="'+href+'" target="'+$(this).attr('target')+'" class="trm_hotSpot '+$(this).attr('class')+'" id="" style="position:absolute;top:'+$(this).attr('y')+';left:'+$(this).attr('x')+';width:'+$(this).attr('w')+';height:'+$(this).attr('h')+';'+debug+'"></a>';
        		hotSpots += '<a onclick="'+clickAction+'" itrack="'+itrack+'" itype="'+$(this).attr('itype')+'" href="'+href+'" target="'+$(this).attr('target')+'" class="trm_hotSpot '+$(this).attr('class')+'" style="'+pos+'"></a>';
        		// hotSpots += '<a href="'+href+'" style="'+pos+'" class="trm_hotSpot '+$(this).attr('class')+'"><img src="'+globalPath+'layout/x.gif" width="'+$(this).attr('w')+'" height="'+$(this).attr('h')+'" alt="'+href+'"></a>'
        	});
